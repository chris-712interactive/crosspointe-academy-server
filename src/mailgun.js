...
const sendOpenEnrollmentEmailToAdmin = (details) => {
    return {
        ...
        html: `<!DOCTYPE html><body><div style="width: 100%; padding: 10px; box-sizing: border-box;display: flex; justify-content: space-between; align-items: center"><img src='https://crosspointeacademyfortmyers.com/images/logo.png' alt="School Logo" style="max-width: 100px" /><h2>New Contact Inquiry Received</h2></div><table style="max-width: 550px; display: block;margin: 30px 0;"><tbody><tr><td style="font-weight: 700;">Name: </td><td>${details.contact.firstName} ${details.contact.lastName}</td></tr><tr><td style="font-weight: 700;">Phone: </td><td>${details.contact.phone}</td></tr><tr><td style="font-weight: 700;">Email: </td><td>${details.contact.email}</td></tr><tr><td style="font-weight: 700;">Inquiry: </td><td>${details.inquiry}</td></tr></tbody></table></body></html>`
    };
}
